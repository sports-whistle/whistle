...
/* header 컨텐츠 */
header h1 { width:100px; height:100px; background:url(../images/Main/Whistle.png) no-repeat 0px 0px; background-size:contain; position:absolute; top:200px;	left:150%; margin-left:-90px;	text-indent:-99999px;}
...
/* 배경이미지 삽입*/
article .bg1 { background-image:url(../images/Main/Inchon.jpg);}
article .bg2 { background-image:url(../images/Main/cheer1.jpg);}
article .bg3 { background-image:url(../images/Main/cheer4.jpg);}
article .bg4 { background-image:url(../images/Main/cheer5.jpg);}
article .bg5 { background-image:url(../images/Main/cheer2.jpg);}
article .bg6 { background-image:url(../images/Main/cheer7.jpg);}
article .bg7 { background-image:url(../images/Main/cheer3.jpg);}
article .bg8 { background-image:url(../images/Main/cheer9.jpg);}
article .bg9 { background-image:url(../images/Main/cars.jpg);}
...
@media screen and (min-width:1280px) and (max-width:1599px) {  
	...
	/* header 컨텐츠 */
	header h1 { width:200px; height:200px; background-image:url(../images/Main/Whistle.png); top:20px; left:20px; margin-left:0px;}	
...
<body>
	<header>
		...
		<div class="snsSet">
			<a href="#"><img src="../images/Main/sns1.png" alt="about" /></a>
			<a href="#"><img src="../images/Main//sns2.png" alt="contact" /></a>
			<a href="#"><img src="../images/Main//sns3.png" alt="facebook" /></a>
			<a href="#"><img src="../images/Main/sns4.png" alt="twitter" /></a>
			<a href="#"><img src="../images/Main/sns5.png" alt="etc" /></a>
		</div>
	</header>
