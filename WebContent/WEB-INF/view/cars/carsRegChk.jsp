...
<body>
	...
	<header id="header" class="clearfix">
		...
		<div id="sentence">
			<p>
				<img src="../resource/images/cars/carsRegChk_P.png" />
			</p>
		</div>
		...
		<tbody>
			...
			<c:forEach var="n" items="${partyList}">
				<tr>
					...
					<td>8</td>
					<td>9</td>
					<td><img src="../resource/images/cars/detailImg.png" /></td> -->
	...
	<div id="enroll">
		<p>
			<a href="carsReg?c=${game.code}"><img src="../resource/images/cars/enroll2.png" /></a>
		</p>
	</div>
