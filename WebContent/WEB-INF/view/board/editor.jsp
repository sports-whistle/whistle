...
<head>
    ...
    -->
    <link rel="stylesheet" href="${ctxName }/resource/editor/css/editor.css" type="text/css" charset="utf-8"/>
    <script src="${ctxName }/resource/editor/js/editor_loader.js" type="text/javascript" charset="utf-8"></script>
	
	
	<style>
			/* customize */
			/* test input for wirter id*/
			
			.tx-nav-attach #custom-title{
				height:28px;
			}
			
			
			.tx-nav-attach #custom-title input{
				width:400px;
				height:19px;
				margin-top:3px;
			}
			...
			.tx-nav-attach #custom-title label,
			.tx-nav-attach #custom-title input{
				font-size:10pt;
...
<div class="body">
				...
				<div class="tx-sidebar-boundary">
					...
					<ul class="tx-bar tx-bar-left tx-nav-attach">
						...
						<!-- 이미지 첨부 버튼 끝 -->
						 ...
						 <li id="custom-title"> <label>제목</label> <input name="title" type="text" /></li>
					</ul>
					<!-- 사이드바 / 우측영역 -->
	...
	<div id="tx_canvas" class="tx-canvas">
		<div id="tx_loading" class="tx-loading"><div><img src="${ctxName }/resource/editor/images/icon/editor/loading2.png" width="113" height="21" align="absmiddle"/></div></div>
	...
	<div id="tx_resizer" class="tx-resize-bar">
		...
		<img id="tx_resize_holder" src="${ctxName }/resource/editor/images/icon/editor/skin/01/btn_drag01.gif" width="58" height="12" unselectable="on" alt="" />
	</div>
	...
	<div id="tx_attach_div" class="tx-attach-div">
		...
		<div id="tx_attach_box" class="tx-attach-box">
			<div class="tx-attach-box-inner">
				<div id="tx_attach_preview" class="tx-attach-preview"><p></p><img src="${ctxName }/resource/editor/images/icon/editor/pn_preview.gif" width="147" height="108" unselectable="on"/></div>
...
<script type="text/javascript">
    ...
    /*     var titlearea = document.createElement('titlearea');
        titlearea.name = 'title';
        titlearea.value = title;
        form.createField(titlearea); */
...
<div><button onclick='saveContent()'>글 등록</button></div>
<!-- End: Saving Contents -->
